...
| `App\Enums\TenantPlan` | Тарифы: `trial` (0), `standard` (9 900 ₽), `max` (14 900 ₽ — всё включено, удвоенные лимиты), `individual` (4 000 000 ₽ — всё + кратно бо́льшие лимиты). `priceRub()` — цена; `features()` — матрица возможностей; `tier()` (Trial→Standard). |
