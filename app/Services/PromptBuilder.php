...
final class PromptBuilder
{
    ...
    public function build(string $businessName, BusinessProfile $profile, Collection $entries): string
    {
        ...
        $sections[] = "Ты — Алиса, AI-администратор бизнеса «{$businessName}». Общаешься с клиентами в ".
            ...
            'что бизнес умеет (см. базу знаний). Такой ответ начни ровно с '.self::CLARIFY.' и сразу за ним — текст '.
            "уточняющего вопроса клиенту (сам сентинел клиент не увидит).\n".
            ...
            '— Когда запись окончательно оформлена (согласованы услуга и дата/время, есть имя и телефон клиента) — '.
            'начни ответ ровно с '.self::BOOKED.' и сразу за ним — короткое подтверждение записи клиенту '.
            "(сам сентинел клиент не увидит). Это сигнал закрыть диалог.\n".
