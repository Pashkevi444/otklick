...
final class PromptBuilder
{
    ...
    public function build(string $businessName, BusinessProfile $profile, Collection $entries, bool $bookingEnabled = false): string
    {
        ...
        $sections[] = "Ты — Алиса, AI-администратор бизнеса «{$businessName}». Общаешься с клиентами в ".
            ...
            'сразу на человека. Задай один короткий уточняющий вопрос, чтобы понять, что нужно клиенту, опираясь на то, '.
            'что бизнес умеет (см. базу знаний). В таком ответе добавь метку '.self::CLARIFY.' (в любом месте — '.
            "клиент её не видит), остальной текст — сам уточняющий вопрос клиенту.\n".
