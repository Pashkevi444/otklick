...
const features = [
    ...
    { icon: '🪄', title: 'Сценарии без программистов', text: 'No-code конструктор воронок: задайте «если клиент написал X → ответь Y, предложи кнопки Z, запиши или позови администратора». Меняете логику бота сами, без разработчиков.' },
