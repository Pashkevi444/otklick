...
const features = [
    { icon: '💬', title: 'Все каналы в одном окне', text: 'Telegram и виджет на сайте. Один помощник отвечает везде одинаково ровно.' },
...
const pricing = [
    {
        ...
        features: ['Все возможности «Стандарта»', 'Telegram и виджет на сайт', 'База знаний и AI-ответы 24/7', 'Без банковской карты'],
        cta: 'Попробовать',
    },
    {
        name: 'Стандарт',
...
<template>
    <Head>
        <title>Отклик — цифровой администратор для бизнеса: ответы в Telegram и на сайте, запись клиентов</title>
        <meta
            name="description"
            content="Отклик — AI-администратор для салонов, барбершопов, клиник и сервиса. Мгновенно отвечает клиентам в Telegram и на сайте по вашей базе знаний и записывает в CRM. Не теряйте заявки 24/7."
        />
        <meta name="keywords" content="AI-администратор, чат-бот для бизнеса, автоответы Telegram, виджет на сайт, запись клиентов, виртуальный помощник, бот для записи, YClients, 152-ФЗ" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Отклик — цифровой администратор для локального бизнеса" />
        <meta
            property="og:description"
            content="Мгновенные ответы клиентам в Telegram и на сайте по вашей базе знаний и запись в CRM. Не теряйте ни одного обращения."
        />
    </Head>
