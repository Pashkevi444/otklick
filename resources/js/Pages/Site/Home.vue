...
const features = [
    ...
    { icon: '📬', title: 'Недельный отчёт «директор»', text: 'Каждый понедельник присылаем владельцу в Telegram/на почту сводку за неделю: сколько лидов, конверсия в запись, что мешает и что улучшить — с ИИ-рекомендациями. Личный аналитик, без захода в кабинет.' },
