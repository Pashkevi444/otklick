...
<template>
    <Head>
        ...
        />
        <meta name="keywords" content="AI-администратор, чат-бот для бизнеса, автоответы Telegram, бот ВКонтакте, бот MAX, мессенджер MAX, виджет на сайт, запись клиентов, виртуальный помощник, бот для записи, YClients, 152-ФЗ" />
