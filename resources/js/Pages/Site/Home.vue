...
// Полный список ниш, под которые уже есть готовые шаблоны (для блока «охват»).
const nicheTags = [
        ...
        <section id="templates" class="mx-auto max-w-6xl px-6 py-16">
            <div data-reveal class="mb-10 text-center">
                ...
                <p class="mx-auto mt-3 max-w-2xl text-slate-500 dark:text-slate-400">
                    Десятки типов бизнеса — для каждого свои готовые сценарии и база знаний. Выберите свою нишу, и останется заменить «…» на свои цены и контакты.
                </p>
            </div>
            ...
            <!-- Охват ниш: под какие типы бизнеса уже есть готовые шаблоны -->
            <div data-reveal class="mt-10">
                <div class="mb-4 text-center text-sm font-medium text-slate-600 dark:text-slate-300">
                    Готовые шаблоны уже есть для десятков ниш:
                </div>
                <div class="mx-auto flex max-w-4xl flex-wrap justify-center gap-2">
                    <span
                        v-for="tag in nicheTags"
                        :key="tag"
                        class="glass rounded-full px-3.5 py-1.5 text-sm text-slate-600 dark:text-slate-300"
                    >
                        {{ tag }}
                    </span>
                </div>
            ...
            <p data-reveal class="mx-auto mt-6 max-w-2xl text-center text-sm text-slate-400 dark:text-slate-500">
                Не нашли свою? Добавим под вашу нишу. И ещё десятки общих шаблонов, подходящих любому бизнесу — всё редактируется под вас.
            </p>
        </section>
