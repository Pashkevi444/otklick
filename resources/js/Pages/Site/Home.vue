...
const features = [
    ...
    { icon: '📨', title: 'Возвращает клиентов рассылками', text: 'Акции и напоминания по базе клиентов — в мессенджеры и на почту, вручную или по расписанию, с отчётом о доставке.' },
    { icon: '👥', title: 'Помнит каждого клиента', text: 'Ведёт базу клиентов: имя, телефон, история обращений. Вернувшегося встречает по имени.' },
    { icon: '📊', title: 'Аналитика и ИИ-подсказки', text: 'Показывает лиды, конверсию и что мешает записям — с рекомендациями, где вы теряете клиентов.' },
...
const pricing = [
    {
        ...
        features: ['Все возможности «Стандарта»', 'Telegram, ВКонтакте, MAX и виджет на сайт', 'База знаний и AI-ответы 24/7', 'Без банковской карты'],
        cta: 'Попробовать',
    },
    {
        name: 'Стандарт',
        ...
        features: ['Telegram, ВКонтакте, MAX и виджет на сайт', 'База знаний (фото, ссылки, цены)', 'AI-ответы 24/7 + передача администратору', 'До 2 операторов', 'Базовая статистика'],
        cta: 'Получить доступ',
    },
    {
        name: 'Макс',
        ...
        features: ['Всё из «Стандарта»', 'CRM YClients: автозапись, отмена, напоминания клиентам', 'База знаний из CRM (услуги, цены, мастера)', 'Рассылки по базе клиентов (мессенджеры + почта, по расписанию)', 'Умный поиск по знаниям (RAG)', 'Расширенная аналитика и ИИ-рекомендации', 'До 10 операторов', 'Больше получателей уведомлений', 'Приоритетная поддержка'],
        cta: 'Получить доступ',
    },
    {
        name: 'Индивидуальный',
