    ...
    <SiteLayout :site="site" :login-url="loginUrl">
        ...
        <section class="mkt-hero relative -mt-[70px] overflow-hidden pb-20 pt-32 sm:pb-24 sm:pt-40">
            ...
            <div aria-hidden="true" class="pointer-events-none absolute inset-0">
                <div class="absolute left-[8%] top-32 hidden h-32 w-44 lg:block" style="background-image: radial-gradient(rgba(255, 255, 255, 0.22) 1.6px, transparent 1.6px); background-size: 18px 18px; opacity: 0.35"></div>
                <div class="absolute bottom-24 right-[9%] hidden h-28 w-40 lg:block" style="background-image: radial-gradient(rgba(255, 255, 255, 0.22) 1.6px, transparent 1.6px); background-size: 18px 18px; opacity: 0.3"></div>
            ...
            <div class="relative mx-auto max-w-4xl px-6 text-center">
                <div data-reveal class="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[13px] font-semibold tracking-wide text-slate-200">
                    <span class="h-1.5 w-1.5 rounded-full bg-[#EE8A5C]"></span>
                    AI-администратор для локального бизнеса
                </div>
                <h1 data-reveal style="transition-delay: 80ms" class="font-display mx-auto mt-7 max-w-4xl text-4xl font-bold leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl xl:text-[64px]">
                    {{ heroHead }}
                    <span class="bg-gradient-to-r from-[#4d7bff] via-[#7C5CFC] to-[#EE8A5C] bg-clip-text text-transparent">{{ heroAccent }}</span>
                </h1>
                <p data-reveal style="transition-delay: 160ms" class="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-[#9AA6BB]">
                    {{ site.heroSubtitle }}
                </p>
                <div data-reveal style="transition-delay: 240ms" class="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
                    ...
                    <Link href="/vozmozhnosti" class="w-full rounded-full border border-white/15 bg-white/5 px-7 py-4 font-semibold text-white transition hover:-translate-y-0.5 hover:bg-white/10 sm:w-auto">Как это работает</Link>
                </div>
                <p data-reveal style="transition-delay: 300ms" class="mt-5 text-sm text-slate-500">{{ site.accessNote }}</p>

                <div data-reveal style="transition-delay: 360ms" class="mt-9 flex flex-wrap items-center justify-center gap-2.5">
                    <span class="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-300"><Icon name="bolt" class="h-4 w-4 text-[#8FB0FF]" /> Ответ за секунды</span>
                    <span class="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-300"><Icon name="clock" class="h-4 w-4 text-[#8FB0FF]" /> Круглосуточно</span>
                    <span class="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-300"><Icon name="shield" class="h-4 w-4 text-[#8FB0FF]" /> Серверы в РФ</span>
                    <span class="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-300"><Icon name="lock" class="h-4 w-4 text-[#8FB0FF]" /> 152-ФЗ</span>
                </div>
                    ...
                    <div class="chat-mock relative rounded-3xl p-4 text-left">
                        <div class="flex items-center gap-2.5 border-b border-white/10 pb-3">
                            ...
                            <div class="leading-tight">
                                <div class="text-sm font-semibold text-white">Отклик</div>
