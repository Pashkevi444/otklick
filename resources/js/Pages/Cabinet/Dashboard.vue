...
<template>
    ...
    <AppLayout title="Дашборд">
        <p class="mb-6 text-slate-600">Управляйте «{{ tenantName }}» — выберите раздел.</p>
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Link
                ...
                :key="card.href"
                :href="card.href"
                class="group block rounded-2xl border border-slate-200 bg-white p-5 transition hover:-translate-y-1 hover:border-[#2E74B5] hover:shadow-lg hover:shadow-slate-100"
            >
                ...
                <div class="mt-4 font-semibold text-[#1F4E79]">{{ card.label }}</div>
