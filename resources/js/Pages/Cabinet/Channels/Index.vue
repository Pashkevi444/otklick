                ...
                <details class="mb-3 rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
                    ...
                    <div class="mt-3 space-y-3">
                        ...
                        <div class="rounded-md bg-white border border-slate-200 p-3">
                            ...
                            <p>Бот отвечает клиентам в личных сообщениях сообщества по вашей <b>базе знаний</b> (раздел «База знаний»), записывает на услуги (если подключена CRM) и передаёт сложные вопросы администратору. Чтобы ответы были точными — заполните базу знаний. Проверить можно так: напишите в сообщество с другого аккаунта — бот ответит, а обращение появится в разделе «Лиды».</p>
                        </div>
                    </div>
                </details>
            ...
            <template v-else-if="form.type === 'max'">
                ...
                <details class="mb-3 rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
                    ...
                    <div class="mt-3 space-y-3">
                        ...
                        <div class="rounded-md bg-white border border-slate-200 p-3">
                            <div class="font-medium text-slate-700">Как это работает дальше</div>
                            <p>Бот отвечает клиентам в MAX по вашей <b>базе знаний</b> (раздел «База знаний»), записывает на услуги (если подключена CRM) и передаёт сложные вопросы администратору. Проверить: напишите боту с другого аккаунта — он ответит, а обращение появится в разделе «Лиды».</p>
                        </div>
                    </div>
                </details>
